...
import { Button, Platform, StyleSheet, Text, Picker, View, Image, TouchableOpacity ,Alert , ScrollView, TextInput} from 'react-native';
...
const AddCouseScreen = () =>  {
    ...
    return (
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Text>{"\n"}</Text>
        {image && <Image source={{ uri: image }} style={{borderColor:"black",borderWidth:2, width: 400, height: 200 }} />} 
      ...
      <TouchableOpacity
       ...
       onPress={() => Alert.alert('Simple Button pressed')}>
        ...
        <Text style = {{color:"white"}}><Ionicons name="ios-add-circle" size={24} color="white" />{"\t"} {"\t"}เพิ่มข้อมูลห้องเรียน</Text>
        </TouchableOpacity>
