...
const HomeScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Image
        style={styles.logo}
        source={require("../assets/digital-learning3.jpg")}
      />
      ...
      <View style={styles.box}>
        ...
        <View style={styles.dropdown}>
          <Picker
            ...
            onValueChange={(itemValue, itemIndex) =>
              setSelectedValue_year(itemValue)
            }
          >
        ...
        <View style={styles.dropdown}>
          <Picker
            ...
            onValueChange={(itemValue, itemIndex) =>
              setSelectedValue_branch(itemValue)
            }
          >
            <Picker.Item label='ทั้งหมด' value='0' />
            ...
            />
            <Picker.Item
              label='BSc. Data Science and Business Analytics '
              value='3'
            />
          </Picker>
        </View>
