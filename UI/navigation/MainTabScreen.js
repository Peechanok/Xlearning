    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarColor: '#694fad',
          tabBarIcon: ({ color }) => (
            <MaterialCommunityIcons name="checkbox-marked" color={color} size={26} />
          ),
        }}
      />
      <Tab.Screen
...
<HomeStack.Navigator screenOptions={{
        ...
        title:'Xlearning',
        headerLeft: () => (
            <Icon.Button name="ios-menu" size={25} backgroundColor="#6495ED" onPress={() => navigation.openDrawer()}></Icon.Button>
        )
        }} />
</HomeStack.Navigator>
);
...
const ProfileScreenStackScreen = ({navigation}) => (
  <DetailsStack.Navigator screenOptions={{
          ...
          <DetailsStack.Screen name="ฉัน" component={ProfileScreen} options={{
          headerLeft: () => (
...
<DetailsStack.Navigator screenOptions={{
        ...
        <DetailsStack.Screen name="ห้องเรียนของฉัน" component={MyCoureScreen} options={{
        headerLeft: () => (
            <Icon.Button name="ios-menu" size={25} backgroundColor="#1f65ff" onPress={() => navigation.openDrawer()}></Icon.Button>
        )
        }} />
...
const RoomScreenStackScreen = ({navigation}) => (
  ...
  const ChatScreenStackScreen = ({navigation}) => (
    <DetailsStack.Navigator screenOptions={{
            ...
            <DetailsStack.Screen name="ข้อความ" component={ChatScreen} options={{
            headerLeft: () => (
                <Icon.Button name="ios-menu" size={25} backgroundColor="#1f65ff" onPress={() => navigation.openDrawer()}></Icon.Button>
            )
            }} />
